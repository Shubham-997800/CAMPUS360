    ...
    <div className="min-h-screen flex animate-fadeIn">
      ...
      <div className="flex-1 flex items-center justify-center p-8 dark:bg-gray-950">
        <div className="w-full max-w-sm">
          <Link to="/" className="inline-flex items-center gap-2.5 text-lg font-bold text-gray-900 dark:text-gray-100 mb-10 lg:hidden">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <div className={`flex items-center gap-3 bg-gray-50 border rounded-xl px-3.5 transition-all focus-within:ring-2 focus-within:ring-blue-500/20 focus-within:border-blue-500 ${errors.password ? 'border-red-400 bg-red-50' : 'border-gray-200 dark:border-gray-700/50'} dark:bg-gray-800`}>
                ...
                <input type={showPw ? 'text' : 'password'} name="password" value={form.password} onChange={handleChange} placeholder="Enter your password" className="flex-1 bg-transparent border-none outline-none py-3 text-sm text-gray-900 dark:text-gray-100 placeholder:text-gray-400 dark:placeholder:text-gray-500" />
                <button type="button" onClick={() => setShowPw(!showPw)} className="text-gray-400 hover:text-gray-600 dark:text-gray-500">
            ...
            <div className="flex items-center justify-between text-sm">
              ...
              <span className="text-blue-600 font-medium cursor-default">Forgot Password?</span>
            </div>
          ...
          <button className="w-full flex items-center justify-center gap-3 bg-white border border-gray-200 text-gray-700 py-3 rounded-xl font-semibold hover:bg-gray-50 transition-all cursor-pointer dark:bg-gray-900 dark:border-gray-700/50 dark:text-gray-300 dark:hover:bg-gray-800">
          ...
          <div className="mt-6 p-3 bg-gray-50 rounded-xl border border-gray-200 text-xs text-gray-500 dark:bg-gray-800 dark:border-gray-700/50 dark:text-gray-400">
          ...
          <p className="text-center text-sm text-gray-500 dark:text-gray-400 mt-4">Don't have an account? <Link to="/register" className="text-blue-600 font-medium hover:underline">Create Account</Link></p>
        </div>
      </div>
    </div>
  )
