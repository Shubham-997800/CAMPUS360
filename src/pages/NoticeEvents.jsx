        ...
        <main className="flex-1 p-6 md:p-8 max-w-6xl w-full animate-fadeIn">
          ...
          <div className="flex gap-1 mb-6 bg-gray-100 dark:bg-gray-800 p-1 rounded-xl w-fit">
            {['notices', 'events'].map(t => (
              <button key={t} onClick={() => handleTabChange(t)} className={`px-5 py-2 rounded-lg text-sm font-semibold transition-all cursor-pointer ${tab === t ? 'bg-white text-gray-900 shadow-sm dark:bg-[#1E293B] dark:text-white' : 'text-gray-500 hover:text-gray-700 dark:text-gray-300 dark:hover:text-white'}`}>
